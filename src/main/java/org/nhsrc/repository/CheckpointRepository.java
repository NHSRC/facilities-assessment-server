...
public interface CheckpointRepository extends BaseRepository<Checkpoint> {
    ...
    Page<Checkpoint> findByLastModifiedDateGreaterThanOrderById(@Param("lastModifiedDateTime") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Date lastModifiedDateTime, Pageable pageable);
}
