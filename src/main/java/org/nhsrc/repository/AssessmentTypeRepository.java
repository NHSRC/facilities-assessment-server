...
public interface AssessmentTypeRepository extends BaseRepository<AssessmentType> {
    ...
    Page<AssessmentType> findByLastModifiedDateGreaterThanOrderById(@DateTimeFormat(pattern = DATE_TIME_FORMAT_STRING) Date lastModifiedDateTime, Pageable pageable);
}