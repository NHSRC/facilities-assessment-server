...
public interface AreaOfConcernRepository extends BaseRepository<AreaOfConcern> {
    ...
    Page<AreaOfConcern> findByLastModifiedDateGreaterThanOrderByLastModifiedDateAsc(@Param("lastModifiedDateTime") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)  Date lastModifiedDateTime, Pageable pageable);
