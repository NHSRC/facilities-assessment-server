...
public interface MeasurableElementRepository extends BaseRepository<MeasurableElement> {
    ...
    Page<MeasurableElement> findByLastModifiedDateGreaterThanOrderById(@DateTimeFormat(pattern = DATE_TIME_FORMAT_STRING) Date lastModifiedDateTime, Pageable pageable);
}
