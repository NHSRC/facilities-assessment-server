...
public interface MeasurableElementRepository extends BaseRepository<MeasurableElement> {
    ...
    Page<MeasurableElement> findByLastModifiedDateGreaterThanOrderByLastModifiedDateAscIdAsc(@Param("lastModifiedDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Date lastModifiedDateTime, Pageable pageable);
